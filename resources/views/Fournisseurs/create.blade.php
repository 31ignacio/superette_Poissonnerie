...
@if (Session::get('success_message'))
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form class="settings-form" method="POST" action="{{ route('fournisseur.store') }}">
                @csrf
                @method('POST')
                            <div class="card-body">
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" id="telephone" name="telephone" value="{{ old('telephone') }}" required style="border-radius:10px;">
