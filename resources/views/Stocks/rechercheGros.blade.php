...
<section class="content">
          ...
          <div class="card">
            ...
            <div class="card-body">
                ...
                <div id="my-table">
                    ...
                    <h4 class="mt-3"><b>Stock enregistré (Gros) du {{ date('d/m/Y', strtotime($dateDebut)) }}  au {{ date('d/m/Y', strtotime($dateFin)) }}</b></h4>
   ...
   <script>
        ...
        var filename = 'Stock_gros_enregistré à la date du' + formattedDate + '.pdf';
