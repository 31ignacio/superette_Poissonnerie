                ...
                <div class="col-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            ...
                            <a href="{{ route('stock.actuelPoissonerie') }}" class="btn bg-gradient-success mt-3"><i class="fas fa-archive"></i> Stocks actuels</a><br><br>
                        </div>
      ...
      <div class="modal fade" id="stockEntryModal" tabindex="-1" aria-labelledby="stockEntryModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <!-- En-tête du modal -->
                <div class="modal-header">
                    <h5 class="modal-title" id="stockEntryModalLabel">Entrée de stock poissonnerie</h5>
                </div>
